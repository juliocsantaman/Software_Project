...
//se crea nuevo file con mismo nombre (hashtable)
using namespace std;
...
int main()
{
    ...
    Ht.Insert(File.WriteAllLines(@"dictionary.txt".ToString(), words));
    Ht.Print(File.WriteAllLines(@"dictionary.txt".ToString(), words));
}
